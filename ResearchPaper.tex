...
% INFO see https://en.wikipedia.org/wiki/Verification_and_validation
...
% TODO "Vectors" or "Models"? Risk vs Threat vs Vulnerability vs Impact? Confirm wording in book
% for now:
% model: wholistic representation of risks, vectors, and mitigations
% vector: a specific mode of attack
% threat: an action or potential action that can harm the org
% vulnerability: a known weakness that can be exploited by a threat
% impact: the badness that occurs as a result of a realized threat
% risk: threat (likeliness) x impact
  ...
  \begin{center}
    \begin{tabular}{|l|c|c|c|c|c|c|}
      ...
      \multicolumn{1}{|c}{\textbf{Switch}} & \multicolumn{6}{|c|}{\textbf{Threat Vector}} \\
                                                                                        \cline{2-7}
      \multicolumn{1}{|c|}{\textbf{Attack}} & \textbi{1a} & \textbi{1b} & \textbi{1c} & \textbi{1d}
                                                              & \textbi{2a} & \textbi{2b} \\ \hline
      Redirection               &        &        & \cmark & \cmark & \cmark & \cmark \\ \hline
      Modification              & \xmark & \xmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      DoS                       &        & \cmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      CAM overflow              & \cmark & \xmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      MAC spoofing              & \cmark & \xmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      Comp. DHCP$^{\mathrm{a}}$ & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      Comp. ARP$^{\mathrm{a}}$  & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark \\ \hline
      \multicolumn{7}{l}{$^{\mathrm{a}}$Compromised switch security features.}
    \end{tabular}
    \label{table:vectors}
  \end{center}
\end{table}
...
% TODO how can this practically be done? Can we really measure anything meaningful?
% TODO how about getting around bound ports?--dedicated machine? then has it's own threats...
