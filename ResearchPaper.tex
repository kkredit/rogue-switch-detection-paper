...
methods for verifying client integrity are well understood \cite{b6}.
% TODO expand on authentication a bit anyway

% TODO could make a flow chart instead. Also, what if it is _not_ connected to a managed switch that
% TODO is already part of the verified network?
